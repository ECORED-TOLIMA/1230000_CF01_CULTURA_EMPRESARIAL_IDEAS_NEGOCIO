...
7. **Tema 5, apartado 5.4.** Es el único bloque del curso donde las dos fuentes describen
...
8. **`bloque-texto-g` de la apertura del Tema 4.** El XD dibuja la franja amarilla de 919 px y
...
9. **Flecha de retroceso del carrusel SMART (4.4).** El artboard dibuja las dos flechas en la
